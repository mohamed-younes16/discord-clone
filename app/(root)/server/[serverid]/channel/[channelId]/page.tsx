...
import { ChevronDown, Hash, Lock, Mic, PlusIcon, Settings, UserCircle2, Video } from "lucide-react";
                ...
                dark:bg-[#191919fc] h-screen">
                        ...
                        <Popover>
                            ...
                            <PopoverContent className='w-48 cursor-pointer '>
                                ...
                                <p className=' p-1   dark:text-indigo-400 
                            ...
                            <ManageServers
                                                ...
                                                icon={<p className=' flex justify-between items-center 
                        ...
                        <div className="flex items-center px-3 w-full justify-between">
                            ...
                            ${channelId == el.name ? "bg-neutral-700 !text-white  dark:bg-neutral-500":""}
