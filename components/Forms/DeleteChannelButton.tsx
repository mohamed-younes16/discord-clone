...
const DeleteChannelButton = ({serverid ,channelId}:{serverid:string,channelId:string}) => {
const router = useRouter()
    ...
    const deleteChannel = async  ()=> {
        ...
        const idDeleted = await deletechannelDB(serverid,channelId)   ||  { valid: false, message:"check your connection" }
...
<DialogTrigger className='w-full'>  <p className=' p-1  text-red-600 flex 
