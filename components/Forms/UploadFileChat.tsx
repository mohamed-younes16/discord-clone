...
const UploadFileChat = ({
  ...
  SetfieldValue: (v: any) => void;
  setFileType: (v: any) => void;
}) => {
  const [endPoint, setEndPoint] = useState<"messageFile" | "imageUploader">(
    "messageFile"
  );
                  ...
                  >
                    <Select
                      onValueChange={(e: string) => {
                        e == "pdf"
                          ? setEndPoint("messageFile")
                          : setEndPoint("imageUploader");
